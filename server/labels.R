...
output$elefanIntroOut <- renderText({
    ...
    text <- paste0(text, "<ol>")
    text <- paste0(text, "<li> Upload a size frequency data set (see Data Considerations or the <a href='https://goo.gl/tsqt64' target='_blank'> Elefan Sample dataset </a>)</li>")
    text <- paste0(text, "<li> Adjust the Assessment Settings")
    text <- paste0(text, "<ol type='a'>")
