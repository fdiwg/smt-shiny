...
output$elefanIntroOut <- renderText({
    ...
    text <- paste0(text, "<ol>")
    text <- paste0(text, "<li> Upload a size frequency data set (see Data Considerations or the <a href='https://data.d4science.net/Sfvj' target='_blank'> Elefan Sample dataset </a>)</li>")
    text <- paste0(text, "<li> Adjust the Assessment Settings")
    text <- paste0(text, "<ol type='a'>")
...
output$elefanSampleDataset <- renderText({
    ...
    link <- "<a href='https://data.d4science.net/Sfvj' target='_blank'>Click Here</a>"
    ...
    text <- paste0(text, "</ul>")
    text <- paste0(text, "<br>")
    text <- paste0(text, "<p> An example dataset in this format can be downloaded <a href='https://data.d4science.net/Sfvj' target='_blank'> here </a>. </p>")
    text <- paste0(text, "<br>")
    text <- paste0(text, "<b>Specific considerations regarding your own dataset:</b>")
    text <- paste0(text, "<ul>")
    text <- paste0(text, "<li>", "Save your dataset in 'csv' format.", "</li>")
